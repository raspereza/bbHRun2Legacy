...
#combineTool.py -M AsymptoticLimits --rMin=0 --rMax=40 --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy=0 --cminDefaultMinimizerTolerance=0.01 -d ${dir}/${ws}.root -n .${ws} -m 125
