...
#  cb.cp().process(mc_processes).channel(["mt","et"]).AddSyst(cb, 'jesTotal2018', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2018_qcdfitpar2', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2018_wfitpar3', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2018_wfitpar4', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2018_ttfitpar1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2018_ttfitpar2', 'shape', ch.SystMap()(1.0))
...
#  cb.cp().process(mc_processes).channel(["mt","et"]).AddSyst(cb, 'jesTotal2017', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2017_qcdfitpar2', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2017_wfitpar3', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2017_wfitpar4', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2017_ttfitpar1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2017_ttfitpar2', 'shape', ch.SystMap()(1.0))
...
#  cb.cp().process(mc_processes).channel(["mt","et"]).AddSyst(cb, 'jesTotal2016', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2016_qcdfitpar2', 'shape', ch.SystMap()(1.0))
  ...
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2016_wfitpar3', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2016_wfitpar4', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2016_ttfitpar1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(['QCD']).channel(["mt","et"]).AddSyst(cb, 'ff2016_ttfitpar2', 'shape', ch.SystMap()(1.0))
