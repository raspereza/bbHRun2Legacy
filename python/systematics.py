...
#  cb.cp().process(mc_processes).channel(["mt","et"]).AddSyst(cb, 'btag2016_preVFP_jes', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_preVFP_hfstats1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_preVFP_hfstats2', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_preVFP_lfstats1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_preVFP_lfstats2', 'shape', ch.SystMap()(1.0))
#  cb.cp().process(mc_processes).channel(["mt","et"]).AddSyst(cb, 'btag2016_postVFP_jes', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_postVFP_hfstats1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_postVFP_hfstats2', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_postVFP_lfstats1', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'btag2016_postVFP_lfstats2', 'shape', ch.SystMap()(1.0))
  cb.cp().process(mc_processes).channel(["mt","et","tt","em"]).AddSyst(cb, 'jesAbsolute', 'shape', ch.SystMap()(1.0))
